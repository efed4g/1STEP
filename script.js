...
// 📌 GİRİŞ YAPMA İŞLEMİ (KULLANICI ADI HARF DUYARSIZ, ŞİFRE TAM HARF DUYARLI KORUMALI)
function handleLogin(e) {
    ...
    // ADMIN GİRİŞ KONTROLÜ (Kullanıcı Adı: Büyük/Küçük Harf Farketmez | Şifre: Birebir Harf Duyarlı!)
...
function handleRegister(e) {
    ...
    if (uNameInput.toLowerCase() === ADMIN_USERNAME.toLowerCase()) {
        showError('regError', "Bu kullanıcı adı Admin'e özeldir!");
        return;
    }
